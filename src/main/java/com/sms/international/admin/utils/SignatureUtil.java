...
public class SignatureUtil {
	 ...
	 * @return
	 */
	public boolean isValid(String signature, String appid, String lol, long millis) {
	...
	public static void main(String[] args) {
		...
		String json = "{\"type\":1,\"method\":1,\"data\":{\"id\":1}}";
		System.out.println(json.getBytes().length);
		String digest = generator.digest(json, "MD5");
		System.out.println(digest);
		System.out.println(digest.getBytes().length);
		String appid = "sioo";
		String token = generator.findTokenById(appid);
		long millis = System.currentTimeMillis();
		String signature = generator.generateSignature(appid, token, digest, millis);

...
<div style="margin: 5px;">
    <input hidden id="channelMonthText" name="month" value="${obj.month}">
    <input hidden id="channelMonthIDText" name="channelid" value="${obj.channelid}">
    <table id="detailMonthTable" lay-filter="detailMonthTable"></table>
</div>
...
<script>
    layui.use(['table','jquery'], function() {
        ...
        //方法级渲染
        table.render({
            elem: '#detailMonthTable',
            method: 'post',
            url: '${ctx }/reportStatis/findChannelMonthDetail',
            where : {month:$('#channelMonthText').val(),channelid:$('#channelMonthIDText').val()},
            cellMinWidth: 80,
            cols: [[ //标题栏
